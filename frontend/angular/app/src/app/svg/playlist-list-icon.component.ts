...
@Component({
  selector: 'app-playlist-list-icon',
  template: `
  <svg fill="#FFFFFF" height="15px" width="15" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
    <g>
...
export class PlaylistListIconComponent {}